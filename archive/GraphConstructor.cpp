...
// GraphConstructor::GraphConstructor(std::map<std::vector<seqan3::dna5>, uint32_t> read2count, graph_arguments args) : read2count_(std::move(read2count)), args(args) {}
...
template<typename ArgsType>
void GraphConstructor<ArgsType>::insert_edge(std::vector<seqan3::dna5> read1, std::vector<seqan3::dna5> read2, int edit_dis)
{
...
template<typename ArgsType>
void GraphConstructor<ArgsType>::edge_summary(){
...
template<typename ArgsType>
void GraphConstructor<ArgsType>::update_graph_omh(std::vector<std::vector<seqan3::dna5>> unique_reads){
...
template<typename ArgsType>
std::vector<std::vector<seqan3::dna5>> GraphConstructor<ArgsType>::mergeUniqueReads(const std::vector<std::vector<std::vector<seqan3::dna5>>>& read_vectors) {
...
template<typename ArgsType>
void GraphConstructor<ArgsType>::visitNeighborsWithThreshold(const Graph& g, Vertex node, int distance_threshold, int current_distance, std::vector<Vertex>& indirect_neighbors, std::vector<bool>& visited) {
...
template<typename ArgsType>
std::vector<Vertex> GraphConstructor<ArgsType>::visitNeighborsOfNeighborsWithThreshold(const Graph& g, Vertex node, int distance_threshold) {
...
template<typename ArgsType>
void GraphConstructor<ArgsType>::save_graph() const {
