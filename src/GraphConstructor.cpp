...
// GraphConstructor::GraphConstructor(std::unordered_map<std::uint64_t, std::vector<std::vector<seqan3::dna5>>> key2reads, std::map<std::vector<seqan3::dna5>, uint32_t> read2count, graph_arguments args) : key2reads_(std::move(key2reads)), read2count_(std::move(read2count)), args(args) {}
